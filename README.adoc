:title: CloudSim Plus: A Modern Java 8 Framework for Modeling and Simulation of Cloud Computing Infrastructures and Services
...
ifdef::env-github[]
= {title} image:https://github.com/cloudsimplus/cloudsimplus-whitepaper/actions/workflows/build-paper.yml/badge.svg[GitHub Pages Build,link=https://cloudsimplus.github.io/cloudsimplus-whitepaper]
endif::[]
...
NOTE: An always up-to-date white paper PDF is https://github.com/cloudsimplus/cloudsimplus-whitepaper/blob/gh-pages/ebook.pdf[available here].
