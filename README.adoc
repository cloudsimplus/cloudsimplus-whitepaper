...
ifdef::env-github[]
= {title} image:https://github.com/cloudsimplus/cloudsimplus-whitepaper/workflows/build-paper/badge.svg[GitHub Pages Publish,link=https://cloudsimplus.github.io/cloudsimplus-whitepaper]
endif::[]
